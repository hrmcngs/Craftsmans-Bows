...
public class ModSoundEvents {
    ...
    public static final net.minecraft.sound.SoundEvent DUNGEONS_BOW_CHARGE_1 = registerSoundEvent("dungeons_bow_charge_1");
    public static final net.minecraft.sound.SoundEvent DUNGEONS_BOW_CHARGE_2 = registerSoundEvent("dungeons_bow_charge_2");
    public static final net.minecraft.sound.SoundEvent DUNGEONS_BOW_CHARGE_3 = registerSoundEvent("dungeons_bow_charge_3");
    public static final net.minecraft.sound.SoundEvent DUNGEONS_BOW_CHARGE_4 = registerSoundEvent("dungeons_bow_charge_4");

    public static final net.minecraft.sound.SoundEvent DUNGEONS_BOW_LOAD = registerSoundEvent("dungeons_bow_load");
